# Generated by Django 4.2.5 on 2023-11-19 14:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=200)),
                ('image', models.ImageField(blank=True, null=True, upload_to='galary/%Y/%m/%d/')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='product_photo/%Y/%m/%d/')),
                ('digital', models.BooleanField(default=False, null=True)),
                ('discount', models.IntegerField(default=0, null=True)),
                ('price_without_discount', models.FloatField(null=True)),
